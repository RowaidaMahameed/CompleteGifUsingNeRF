...
def render_test(args):
    ...
    if args.render_path:
        ...
        os.makedirs(f'{logfolder}/{args.expname}/path', exist_ok=True)
        evaluation_path(test_dataset, tensorf, c2ws, renderer, f'{logfolder}/{args.expname}/path/',
                        N_vis=-1, N_samples=-1, white_bg=white_bg, ndc_ray=ndc_ray, device=device)
